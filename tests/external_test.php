...
final class external_test extends \advanced_testcase {
    ...
    public function test_get_sharable_question_choices_working(): void {
        ...
        $qbank = $this->getDataGenerator()->create_module(
            'qbank',
            [
                'course' => $course->id,
                'idnumber' => 'abc123',
    ...
    public function test_get_sharable_question_choices_no_permissions(): void {
        ...
        $this->setUser($user);
        $qbank1 = $this->getDataGenerator()->create_module(
            'qbank',
            [
                'course' => $course->id,
            ]
    ...
    public function test_get_embed_code_working(
        ...
        string $qbankidnumber,
        string $expectedembedid
    ): void {
        $this->resetAfterTest();
        $this->setAdminUser();
        $generator = $this->getDataGenerator();
        ...
        $actual = external::get_embed_code(
            $qbank->cmid,
            $embedid->categoryidnumber,
            $embedid->questionidnumber,
            $iframedescription,
            $behaviour,
            $maxmark,
            $variant,
